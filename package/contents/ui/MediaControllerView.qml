...
//                visible: !!root.track && status === Image.Ready
            ...
            ColumnLayout {
                ...
                PlasmaExtras.Heading {
                    id: song
                    Layout.fillWidth: true
                    Layout.alignment: root.track ? Qt.AlignTop : Qt.AlignVCenter
                    horizontalAlignment: root.track ? Text.AlignLeft : Text.AlignHCenter
                    level: 3
                    opacity: 0.6
    ...
    PlasmaExtras.Heading {
        anchors.bottom: playerControlsContainer.top
